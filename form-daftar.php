...
<div class="container">
    ...
    <header class="mt-4">
    <h3 class=" fw-bold">FORMULIR <span style="color: red">PENDAFTARAN ANGGOTA MPK</span></h3>
    </header>
    ...
    <form action="proses-pendaftaran.php" method="POST" class="p-3">
        <fieldset>
            ...
            <a href="index.php" class="btn btn-danger">kembali <i class="bi bi-arrow-right"></i></a>
            </center>
        </fieldset>
    </form>
